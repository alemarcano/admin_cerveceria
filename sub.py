...
def doQuery(a):
    cur = conn.cursor()
    cur.execute('INSERT INTO lote ("cantidadenviada", "fecha", "fkproveedor", "fkmp", "estado", "precio$") VALUES (%s, %s, %s, %s, %s, %s );', (a["cantidad"],a["fecha"],a["proveedor"],a["mp"], a["est"], a["costototal"] ))
    conn.commit()
